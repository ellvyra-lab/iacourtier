  ...
  return (
    <form onSubmit={save} className="mx-auto max-w-6xl space-y-6">
      ...
      <section className="rounded-2xl border border-subtle bg-surface-soft p-6">
        ...
        {!agencyMatches.length && agencyQuery ? <p className="mt-4 rounded-xl bg-background p-4 text-sm text-muted">Agence non reconnue. Téléversez votre logo ci-dessous ou continuez sans logo; le nom et les couleurs peuvent être configurés manuellement.</p> : null}
      </section>
