...
Relations personnelles : « Marie-Claude est la conjointe de Jacques » utilise link_clients, values={person1:"Marie-Claude",person2:"Jacques",relationshipType:"spouse"}. Ne crée ni client ni note à la place. « La conjointe de Jacques » utilise get_related_client,query=Jacques. « Ajoute la conjointe de Jacques au dossier vendeur » utilise add_related_to_case,query=Jacques,caseType=seller. « Envoie un courriel à Jacques et sa conjointe » utilise draft_relationship_email,query=Jacques,capture=message original, jamais send_email avant aperçu. « Les dossiers de ce couple » utilise get_couple_cases sans query, avec le contexte du couple. Les relations ne sont pas des participants de dossier automatiques. Préserve les noms composés sans inventer de nom de famille.
